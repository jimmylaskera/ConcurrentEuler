...
public class WorkStealingSolution {
    /**
	 * Version that utilizes a work stealing thread pool to calculate the Euler number.
    ...
    public static void main(String[] args) {
		...
		try {
			...
			System.out.println("There were " + pool.getActiveThreadCount() + " active threads in the pool.");
			executor.shutdown();
		}
